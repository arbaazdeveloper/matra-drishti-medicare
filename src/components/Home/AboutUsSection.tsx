...
const AboutSection = () => {
  ...
  const features = [
    ...
    {
      title: "Expert Team",
      description: "Highly qualified medical professionals with years of experience in Patient's health.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="about" className="py-16 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mt-2 playfair-font">Comprehensive Patient's Healthcare</h2>
