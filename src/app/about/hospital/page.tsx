...
export const metadata: Metadata = {
  title: "Matra  Drishti Medicare Hospital | Best Facilities Hospital in Jankipuram Extension, Lucknow",
  description:
    "Matra  Drishti Medicare Hospital in Jankipuram Extension, Lucknow offers advanced healthcare services including gynecology, ophthalmology, cardiology, infertility treatments, and general surgeries with modern facilities and experienced doctors.",
  keywords: [
  ...
  openGraph: {
    title: "Matra  Drishti Medicare Hospital | Jankipuram Extension Lucknow",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Matra  Drishti Medicare Hospital Jankipuram Lucknow"
      }
    ]
  }
};
