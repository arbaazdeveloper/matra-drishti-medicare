...
const DoctorProfilePage = () => {
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 pt-20">
            ...
            <section className="relative py-12 md:py-24 text-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl font-bold mb-4 playfair-font">Dr.Rajesh Gupta</h1>
                            <p className="text-xl md:text-2xl mb-6">Best Eye Surgeon in Lucknow</p>
                        ...
                        >
                            <div className="relative">
                                <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white shadow-2xl">
                                    <Image
                                        src="https://res.cloudinary.com/dxknbk2hd/image/upload/v1757836599/matra-drishti-medicare/dr.rajes_k3hyaa.jpg"
                                        alt="Dr.Rajesh Gupta"
                                        width={320}
                                        height={320}
                        ...
                        >
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center">
                                    ...
                                    Cataract Surgery (Phacoemulsification & Advanced IOLs)
                                </li>
                                <li className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                ...
                                <li className="flex items-center">
                                    ...
                                    Pediatric & Squint Eye Treatment
                                </li>
                                <li className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                    </svg>
                                    Refractive Errors & LASIK Surgery
                                </li>
                                <li className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-gray-800 mb-4 playfair-font">Why Choose Dr.Rajesh Gupta?</h2>
                        <div className="w-24 h-1 bg-pink-500 mx-auto mb-6"></div>
                        <p className="text-gray-700 max-w-3xl mx-auto">
                            Dr.Rajesh stands out as one of Lucknow's leading gynecologists for several compelling reasons
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                description: "Renowned for his compassionate approach, Dr. Rajesh ensures patients feel comfortable, informed, and supported throughout their treatment journey.",
                                icon: (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                description: "Equipped with the latest ophthalmic technology, he provides advanced diagnostic and surgical solutions for optimal eye care.",
                                icon: (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                description: "Dr. Rajesh designs individualized treatment plans, ensuring that every patient receives care tailored to their unique vision needs.",
                                icon: (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                description: "From cataract and glaucoma management to LASIK and retina care, Dr. Rajesh offers comprehensive eye care solutions under one roof.",
                                icon: (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            },
                            {
                                ...
                                description: "Through dedication and precision, Dr. Rajesh has earned a reputation for consistently achieving excellent outcomes and patient satisfaction.",
                                icon: (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <motion.div
                                key={index}
                                className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl shadow-md text-center"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <div className="w-24 h-1 bg-pink-500 mx-auto mb-6"></div>
      <p className="text-gray-700 max-w-3xl mx-auto">
        Hear what Dr. Rajesh's patients have to say about their experience
      </p>
    </motion.div>
      ...
      {[
        {
          name: "Suresh Yadav",
          review:
            "I had cataract surgery done by Dr. Rajesh and the results were amazing. The entire procedure was smooth, and I regained clear vision the very next day. Truly one of the best eye surgeons in Lucknow.",
          rating: 5,
        },
        {
          name: "Meera Tiwari",
          review:
            "Dr. Rajesh treated my mother for glaucoma. His calm approach and clear explanation of the treatment gave us confidence. The surgery went perfectly and my mother is very happy with the results.",
          rating: 5,
        },
        {
          name: "Arun Singh",
          review:
            "I was struggling with vision issues for years. After consulting Dr. Rajesh, I underwent LASIK surgery and now I can see without glasses. His expertise and care are outstanding.",
          rating: 5,
        },
