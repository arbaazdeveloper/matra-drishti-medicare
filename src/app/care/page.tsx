...
//                       <div className="bg-pink-100 text-pink-600 p-2 rounded-lg mr-4 flex-shrink-0">
...
import CarePage from './Information'
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: "Best Healthcare Facilities in Lucknow | Matra Drishti Medicare",
  description:
    "Explore the advanced healthcare facilities at Matra Drishti Medicare in Lucknow, offering gynecology, ophthalmology, cardiology, general surgery, and specialized care. Equipped with modern technology and compassionate staff for the best patient experience.",
  keywords: [
    "hospital facilities in Lucknow",
    "best hospital in Jankipuram",
    "Matra Drishti Medicare facilities",
    "gynecology facilities Lucknow",
    "cardiology OPD Lucknow",
    "ophthalmology hospital Lucknow",
    "general surgery facilities Lucknow",
    "top hospital in Lucknow"
  ],
  openGraph: {
    title: "Best Healthcare Facilities in Lucknow | Matra Drishti Medicare",
    description:
